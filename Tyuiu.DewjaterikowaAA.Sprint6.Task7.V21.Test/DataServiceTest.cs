using Tyuiu.DewjaterikowaAA.Sprint6.Task7.V21.Lib;
namespace Tyuiu.DewjaterikowaAA.Sprint6.Task7.V21.Test
{
    [TestClass]
    public sealed class DataServiceTest
    {
        ...
        {
            string path = @"C:\DataSprint5\InPutDataFileTask7V21.csv";
        ...
        public void ValidCalc()
        {
            ...
            int[,] wait = {{-4,-2,13,-12,12,-19,5,-1,-6,-12},
